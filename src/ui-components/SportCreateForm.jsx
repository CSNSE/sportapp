...
export default function SportCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setSat(initialValues.sat);
    setAct(initialValues.act);
    setAps(initialValues.aps);
    ...
    setStat3(initialValues.stat3);
    setStat4(initialValues.stat4);
    setStat5(initialValues.stat5);
    setStat6(initialValues.stat6);
